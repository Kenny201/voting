                    ...
                    <div
                        ...
                        <button
                            ...
                            <ul
                                ...
                                class="absolute ml-8 font-semibold text-left bg-white w-44 shadow-dialog rounded-xl">
                                <li>
                                    <a href=""
                        ...
                        <div
                            ...
                            <button
                                ...
                                <ul
                                    ...
                                    @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false"
                                    class="absolute z-20 ml-8 font-semibold text-left bg-white w-44 shadow-dialog rounded-xl">
                                    <li>
                                        <a href=""
                                           class="block px-5 py-3 transition duration-150 ease-in hover:bg-gray-100 ">Mark
                                            a span</a>
